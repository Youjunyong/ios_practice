...
class ViewController: UIViewController , AVAudioPlayerDelegate{
    ...
    private func configreRecordSwtich(){
        ...
        NSLayoutConstraint.activate([
            recordSwitch.leadingAnchor.constraint(equalTo: recordLabel.trailingAnchor, constant: 30),
            ...
            recordTimeLabel.centerXAnchor.constraint(equalTo: recordSwitch.centerXAnchor),
